...
entry = f"| DC-{next_num} | 2026-09-06T21:30:00Z | Create AAAC README | Added README_AAAC.md with quick start, component list, and compliance references. | README created | Complete |\n"
...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Create AAAC README | 2026-09-06 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## README Created — 2026-09-06 (DC-{next_num})
...
'''
if 'README Created' not in state_text:
