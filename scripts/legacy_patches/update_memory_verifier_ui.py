...
entry = f"| DC-{next_num} | 2026-09-07T08:30:00Z | Add sovereign verifier UI (static HTML) | Created docs/sovereign_verifier.html using WebCrypto to verify chain hashes and RSA signatures entirely client-side. User uploads chain and public keys. No server required. | Static verifier ready for use | Complete |\n"
...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Add sovereign verifier UI (static HTML) | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Sovereign Verifier UI — 2026-09-07 (DC-{next_num})
...
'''
if 'Sovereign Verifier UI' not in state_text:
