...
entry = f"| DC-{next_num} | 2026-09-07T13:15:00Z | Advanced compliance engine | Replaced simple policy with rules-based engine supporting priorities, AND/OR logic, numeric comparisons, regex, and default deny. Added tests proving allow, forbidden command, and high-risk transfer handling. | Advanced compliance rules working | Complete |\n"
...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Advanced compliance engine | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Advanced Compliance Engine — 2026-09-07 (DC-{next_num})
...
'''
if 'Advanced Compliance Engine' not in state_text:
