...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Add blockchain anchoring (local PoC) | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Blockchain Anchoring — 2026-09-07 (DC-{next_num})
...
'''
if 'Blockchain Anchoring' not in state_text:
