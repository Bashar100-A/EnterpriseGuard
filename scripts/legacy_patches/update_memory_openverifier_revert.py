...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Revert open_verifier to working version | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Open Verifier Reverted — 2026-09-07 (DC-{next_num})
...
'''
if 'Open Verifier Reverted' not in state_text:
