...
entry = f"| DC-{next_num} | 2026-09-07T14:00:00Z | Deploy blockchain anchor on Sepolia testnet | Deployed Anchor.sol on Sepolia using web3.py and private key. Anchored latest innocence ring. Contract address and tx hash recorded. System now has public verifiable proof. | Sepolia anchoring successful | Complete |\n"
...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Deploy blockchain anchor on Sepolia testnet | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Sepolia Blockchain Anchoring — 2026-09-07 (DC-{next_num})
...
'''
if 'Sepolia Blockchain Anchoring' not in state_text:
