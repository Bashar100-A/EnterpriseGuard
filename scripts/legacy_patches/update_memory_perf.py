...
entry = f"| DC-{next_num} | 2026-09-07T15:20:00Z | ECDSA performance benchmark result | Measured signing speed: RSA 320.61 ms/sig, ECDSA 0.67 ms/sig. Improvement 99.8%. Achieved investor condition of ≥40% improvement. | Performance benchmark documented | Complete |\n"
...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | ECDSA performance benchmark result | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Performance Benchmark — 2026-09-07 (DC-{next_num})
...
'''
if 'Performance Benchmark' not in state_text:
