...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Regenerate keys and reinitialize chain | 2026-09-07 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Key Reset and Reinitialization — 2026-09-07 (DC-{next_num})
...
'''
if 'Key Reset and Reinitialization' not in state_text:
