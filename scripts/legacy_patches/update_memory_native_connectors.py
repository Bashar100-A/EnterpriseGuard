...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Create native connectors for LangSmith/Langfuse | 2026-09-06 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Native Connectors — 2026-09-06 (DC-{next_num})
...
'''
if 'Native Connectors' not in state_text:
