...
if insert_pos is not None:
    lines.insert(insert_pos, f"| DC-{next_num} | Strict TSA signature verification with CA chain | 2026-09-06 |")
    new_index = '\n'.join(lines) + '\n'
else:
...
## Strict TSA Verification — 2026-09-06 (DC-{next_num})
...
'''
if 'Strict TSA Verification' not in state_text:
